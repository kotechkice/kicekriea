...
{% include 'tch/container/manage_probs.js' %}
...
function ready_func(){
    ...
    html += '                <span class="user-email" style="font-size:small">User : test@sample.net</span>';
    html += '            </td>';
    ...
    html += '                <a class="qr_code_link" href="https:/kice.kriea.co.kr/tch">';
    html += '                    <img class="response_qr_code" src="http://chart.apis.google.com/chart?chs=100x100&cht=qr&chld=|0&chl=jindan.kice.re.kr/tch" title="Scan this for more information about the standard" width="90px" height="90px" />';
    html += '                </a>';
    html += '            </td>';
    html += '        </tr>';
    html += '    </table>';
    ...
    //$('body').append(head_html);
    //$('.assess-title:last').text('과제물(함수)');
    //$('body').append(workbook_probs_html);
    //make_prob_html(1900, 1, $('.prob_left .prob_top>td'));
    //make_prob_html(1901, 2, $('.prob_left .prob_bottom>td'));
    
    //$('body').append(foot_html);
    //making_one_prob_complete_flag = false;
    //
    //console.log('start');
    //while(!making_one_prob_complete_flag){
    //    console.log(making_one_prob_complete_flag);
    //};
    //console.log(one_prob_html);
}
